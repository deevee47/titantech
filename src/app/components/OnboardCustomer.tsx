...
const OnboardCustomer = () => {
  ...
  const ImageUploadSection = ({ 
    ...
    <div className="space-y-2">
      ...
      <div className="border border-gray-600/40 rounded-xl p-4 bg-gray-800/20 backdrop-blur-sm shadow-lg hover:shadow-blue-500/10 transition-all duration-300 hover:scale-[1.02]">
        {images[type].preview ? (
          ...
          <label className="block relative cursor-pointer">
            <Input
              ...
              className="sr-only"
            />
            <div className="w-full h-40 border-dashed border-2 border-gray-600/60 rounded-lg flex items-center justify-center bg-transparent hover:bg-gray-800/30 text-gray-300 transition-all duration-300 hover:border-blue-500/50 group">
              <div className="flex items-center">
                <Upload className="mr-2 h-5 w-5 group-hover:scale-110 transition-transform duration-300" />
                <span className="text-lg group-hover:text-blue-400 transition-colors">Upload {title}</span>
              </div>
            </div>
          </label>
        )}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#001524] via-[#0a1f30] to-[#1a1a2e] py-12">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto space-y-8 bg-gray-900/30 backdrop-blur-md p-8 rounded-2xl shadow-2xl border border-gray-800/50 hover:shadow-blue-500/10 transition-shadow duration-300">
          ...
          <div className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2 animate-fade-in-up delay-100">
                ...
                <Input
                  ...
                  placeholder="John"
                  className="bg-transparent border-0 border-b-2 border-gray-600/50 rounded-none text-gray-300 text-lg placeholder:text-gray-500 focus:border-blue-500 focus:ring-0 pb-2 transition-colors shadow-sm hover:border-blue-400"
                />
              </div>
              ...
              <div className="flex gap-2">
                <div className="w-16">
                  <Input
                    ...
                    value="+91"
                    readOnly
                    className="bg-transparent border-0 border-b-2 border-gray-600/50 rounded-none text-gray-300 text-lg focus:ring-0 pb-2 text-center transition-colors shadow-sm"
                  />
                </div>
                <Input
                  name="phone"
            ...
            <div className="space-y-2 animate-fade-in-up delay-350">
              ...
              <Textarea
                ...
                className="bg-transparent border border-gray-600/50 rounded-lg text-gray-300 placeholder:text-gray-500 focus:border-blue-500 focus:ring-0 min-h-[100px] shadow-sm hover:border-blue-400"
              />
            </div>
          </div>
          ...
          <div className="space-y-6 pt-4">
            ...
            <div className="flex items-center justify-between p-4 bg-gray-800/20 rounded-lg border border-gray-600/40 shadow-lg animate-fade-in-up delay-600">
          ...
          <Button 
            ...
            disabled={loading}
            className="w-full bg-blue-500 hover:bg-blue-600 text-white py-6 text-lg rounded-lg transition-all duration-300 shadow-lg hover:shadow-blue-500/50 mt-8 animate-fade-in-up delay-700"
          >
